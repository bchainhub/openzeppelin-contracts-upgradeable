...
import "../../src/access/AccessControlUpgradeable.sol";
import "../../src/utils/StringsUpgradeable.sol";

contract AccessControlUpgradeableMock is AccessControlUpgradeable {
...
contract AccessControlUpgradeableTest is Test {
    ...
    AccessControlUpgradeableMock private _access;
    ...
    function setUp() public {
        ...
        _authorized = makeAddr("authorized");
        _other = makeAddr("other");
        _otherAdmin = makeAddr("otherAdmin");

        _access = new AccessControlUpgradeableMock();
        _access.initialize();
