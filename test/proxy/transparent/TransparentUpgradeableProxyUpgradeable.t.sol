...
contract TransparentUpgradeableProxyUpgradeableTest is Test {
    ...
    function setUp() public {
        ...
        _implementationV0 = address(new DummyImplementationUpgradeable());
        _implementationV1 = address(new DummyImplementationUpgradeable());
    ...
    function testDelegatesToImplementation() public {
        DummyImplementationUpgradeable dummy = DummyImplementationUpgradeable(_proxyAddress);
    ...
    function testTransparentProxyAdminCannotFallback() public {
        ClashingImplementationUpgradeable impl = new ClashingImplementationUpgradeable();
        ITransparentUpgradeableProxyMock proxy = _createProxy(address(impl), _proxyAdminAddress, "");

        vm.prank(_proxyAdminAddress);
        vm.expectRevert(bytes("TransparentUpgradeableProxy: admin cannot fallback to proxy target"));
        ClashingImplementationUpgradeable(address(proxy)).delegatedFunction();
    }
    ...
    function testClashAdminAsOther() public {
        ...
        vm.prank(_anotherAccount);
        address value = ClashingImplementationUpgradeable(address(proxy)).admin();
    ...
    function testRegressionAddFunction() public {
        Implementation1Upgradeable instance1 = new Implementation1Upgradeable();
        ITransparentUpgradeableProxyMock proxy = _createProxy(address(instance1), _proxyAdminAddress, "");

        Implementation1Upgradeable proxyInstance1 = Implementation1Upgradeable(address(proxy));
        vm.prank(_anotherAccount);
        proxyInstance1.setValue(42);

        Implementation2Upgradeable instance2 = new Implementation2Upgradeable();
        vm.prank(_proxyAdminAddress);
        proxy.upgradeTo(address(instance2));

        Implementation2Upgradeable proxyInstance2 = Implementation2Upgradeable(address(proxy));
        vm.prank(_anotherAccount);
    ...
    function testRegressionRemoveFunction() public {
        Implementation2Upgradeable instance2 = new Implementation2Upgradeable();
        ITransparentUpgradeableProxyMock proxy = _createProxy(address(instance2), _proxyAdminAddress, "");
        ...
        Implementation2Upgradeable proxyInstance1 = Implementation2Upgradeable(address(proxy));
        vm.prank(_anotherAccount);
        vm.expectRevert();
    ...
    function testRegressionChangeSignature() public {
        ...
        Implementation3Upgradeable instance3 = new Implementation3Upgradeable();
        vm.prank(_proxyAdminAddress);
        proxy.upgradeTo(address(instance3));

        Implementation3Upgradeable proxyInstance3 = Implementation3Upgradeable(address(proxy));
        vm.prank(_anotherAccount);
    ...
    function testRegressionAddFallbackFunction() public {
        ...
        Implementation4Upgradeable instance4 = new Implementation4Upgradeable();
        vm.prank(_proxyAdminAddress);
        ...
        Implementation4Upgradeable proxyInstance4 = Implementation4Upgradeable(address(proxy));
        vm.prank(_anotherAccount);
    ...
    function testRegressionRemoveFallbackFunction() public {
        Implementation4Upgradeable instance4 = new Implementation4Upgradeable();
        ITransparentUpgradeableProxyMock proxy = _createProxy(address(instance4), _proxyAdminAddress, "");
