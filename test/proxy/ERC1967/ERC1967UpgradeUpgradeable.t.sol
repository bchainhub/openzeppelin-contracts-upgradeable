...
import "../../../src/proxy/ERC1967/ERC1967UpgradeUpgradeable.sol";

contract DummyImplementationERC1967Upgradeable {
...
contract ERC1967UpgradeUpgradeableHarness is ERC1967UpgradeUpgradeable {
...
contract ERC1967UpgradeUpgradeableTest is Test {
    ...
    function setUp() public {
        _implementation = new DummyImplementationERC1967Upgradeable();
    }
    ...
    function testSlotHashImplementation() public {
        ...
        ERC1967UpgradeUpgradeableHarness harness = new ERC1967UpgradeUpgradeableHarness();
        ...
        private
    {
        ...
        assertEq(DummyImplementationERC1967Upgradeable(address(proxy)).value(), expectedValue);
