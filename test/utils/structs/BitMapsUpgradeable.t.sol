...
import "../../../src/utils/structs/BitMapsUpgradeable.sol";

contract BitMapsUpgradeableMock {
    using BitMapsUpgradeable for BitMapsUpgradeable.BitMap;

    mapping(uint256 => BitMapsUpgradeable.BitMap) private _maps;
...
contract BitMapsUpgradeableTest is Test {
    BitMapsUpgradeableMock private _bitmap;
    ...
    function setUp() public {
        _bitmap = new BitMapsUpgradeableMock();
    }
