...
import "../../../src/utils/structs/EnumerableSetUpgradeable.sol";

contract EnumerableSetUpgradeableMock {
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.Bytes32Set;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.UintSet;

    mapping(uint256 => EnumerableSetUpgradeable.Bytes32Set) private _bytes32Sets;
    mapping(uint256 => EnumerableSetUpgradeable.AddressSet) private _addressSets;
    mapping(uint256 => EnumerableSetUpgradeable.UintSet) private _uintSets;
...
contract EnumerableSetUpgradeableTest is Test {
    EnumerableSetUpgradeableMock private _set;
    ...
    function setUp() public {
        _set = new EnumerableSetUpgradeableMock();
    }
