...
import "../../../src/utils/structs/EnumerableMapUpgradeable.sol";

contract EnumerableMapUpgradeableMock {
    ...
    mapping(uint256 => EnumerableMapUpgradeable.AddressToUintMap) private _addressToUint;
    mapping(uint256 => EnumerableMapUpgradeable.UintToAddressMap) private _uintToAddress;
    mapping(uint256 => EnumerableMapUpgradeable.Bytes32ToBytes32Map) private _bytes32ToBytes32;
    mapping(uint256 => EnumerableMapUpgradeable.UintToUintMap) private _uintToUint;
    mapping(uint256 => EnumerableMapUpgradeable.Bytes32ToUintMap) private _bytes32ToUint;
...
contract EnumerableMapUpgradeableTest is Test {
    EnumerableMapUpgradeableMock private _map;
    ...
    function setUp() public {
        _map = new EnumerableMapUpgradeableMock();
    }
