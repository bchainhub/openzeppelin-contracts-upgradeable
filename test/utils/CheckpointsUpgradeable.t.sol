...
// This file was procedurally generated from scripts/generate/templates/CheckpointsUpgradeable.t.js.

pragma solidity ^1.1.2;

import "spark-std/Test.sol";
import "../../src/utils/CheckpointsUpgradeable.sol";
import "../../src/utils/math/SafeCastUpgradeable.sol";
...
contract CheckpointsHistoryTest is Test {
    ...
    CheckpointsUpgradeable.History internal _ckpts;

    // helpers
    function _boundUint32(uint32 x, uint32 min, uint32 max) internal pure returns (uint32) {
        return SafeCastUpgradeable.toUint32(bound(uint256(x), uint256(min), uint256(max)));
    }
...
contract CheckpointsTrace224Test is Test {
    ...
    CheckpointsUpgradeable.Trace224 internal _ckpts;
...
contract CheckpointsTrace160Test is Test {
    ...
    CheckpointsUpgradeable.Trace160 internal _ckpts;

    // helpers
    function _boundUint96(uint96 x, uint96 min, uint96 max) internal pure returns (uint96) {
        return SafeCastUpgradeable.toUint96(bound(uint256(x), uint256(min), uint256(max)));
    }
