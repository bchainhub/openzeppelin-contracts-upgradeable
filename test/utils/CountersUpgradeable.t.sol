...
import "../../src/utils/CountersUpgradeable.sol";

contract CountersUpgradeableMock {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    mapping(uint256 => CountersUpgradeable.Counter) private _counters;
...
contract CountersUpgradeableTest is Test {
    CountersUpgradeableMock private _counter;

    function setUp() public {
        _counter = new CountersUpgradeableMock();
    }
