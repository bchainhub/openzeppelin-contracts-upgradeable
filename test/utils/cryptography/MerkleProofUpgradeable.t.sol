...
import "../../../src/utils/cryptography/MerkleProofUpgradeable.sol";

contract MerkleProofUpgradeableHarness {
    ...
    function multiProofVerifyCalldata(
        ...
        return MerkleProofUpgradeable.multiProofVerifyCalldata(proof, proofFlags, root, leaves);
    }
}

contract MerkleProofUpgradeableTest is Test {
    MerkleProofUpgradeableHarness private _proof;

    function setUp() public {
        _proof = new MerkleProofUpgradeableHarness();
    }
