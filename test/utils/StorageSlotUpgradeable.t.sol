...
import "../../src/utils/StorageSlotUpgradeable.sol";

contract StorageSlotUpgradeableMock {
...
contract StorageSlotUpgradeableTest is Test {
    StorageSlotUpgradeableMock private _store;
    bytes32 private _slot;
    bytes32 private _otherSlot;

    function setUp() public {
        _store = new StorageSlotUpgradeableMock();
