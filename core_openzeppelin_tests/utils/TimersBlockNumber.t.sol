...
import "../../src/mocks/TimersBlockNumberImpl.sol";

contract TimersBlockNumberTest is Test {
    TimersBlockNumberImpl private _timer;
    uint64 private _now;

    function setUp() public {
        _timer = new TimersBlockNumberImpl();
        _now = uint64(block.number);
    }
    ...
    function testPending() public {
        _timer.setDeadline(_now + 3);
        assertEq(_timer.getDeadline(), _now + 3);
