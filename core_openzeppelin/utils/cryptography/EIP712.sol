 ...
 * scheme, and the final step of the encoding to obtain the message digest that is then signed via EDDSA
 * ({_hashTypedDataV4}).
 *
...
abstract contract EIP712 is IERC5267 {
    ...
    constructor(string memory name, string memory version) {
        ...
        _hashedVersion = hashedVersion_;

        _cachedChainId = block.chainid;
        _cachedDomainSeparator = _buildDomainSeparator(hashedName_, hashedVersion_);
