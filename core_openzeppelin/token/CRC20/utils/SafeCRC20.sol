...
import "../ICRC20.sol";
import "../extensions/ICRC20Permit.sol";
...
library SafeCRC20 {
     ...
     */
    function forceApprove(ICRC20 token, address spender, uint256 value) internal {
     ...
     */
    function _callOptionalReturnBool(ICRC20 token, bytes memory data) private returns (bool) {
        // We cannot use {Address-functionCall} here since this should return false
